...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_TABLE_EMPLOYEES = " CREATE TABLE " + TABLE_EMPLOYEE
            + " ( "
...
//                        ");"
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(SQL_TABLE_EMPLOYEES);
    ...
    public User Authenticate(User user) {
        ...
        Cursor cursor = db.query(TABLE_USERS,// Selecting Table
                new String[]{KEY_ID, KEY_USER_NAME, KEY_EMAIL, KEY_PASSWORD,KEY_PHONE},//Selecting columns want to query
                KEY_EMAIL + "=?",
